...
Version="1.3.0.15"
Release=""
ID=226d5a0c28a91c0191d10722208e660e
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[1.3.0]\0A- #196 improve logger state resilience to disconnected and unconfigured connections"
...
[Dependencies]
AutoReqProv=FALSE
Requires="jdp_science_lib_common_utilities>=1.4.2.19,jdp_science_postgresql>=0.6.2.48,jki_lib_state_machine>=2018.0.7.45,jki_statemachineobjects>=1.4.0.69,labview_open_source_lib_epoch_datetime>=1.3.0.8,levylab_lib_fileutilities>=1.2.6.13,levylab_lib_lvtdatpgsql>=3.12.1.15,levylab_lib_lvtoitx>=3.10.0.9,levylab_lib_xy_utilities>=1.9.0.13,mgi_lib_1d_array>=1.0.2.3,mgi_lib_numeric>=1.1.0.2,national_instruments_lib_guid_generator>=1.0.2.3,oglib_appcontrol>=4.1.0.7,oglib_array>=4.1.1.14,oglib_dictionary>=4.0.0.4,oglib_error>=4.2.0.23,oglib_file>=4.0.1.22,oglib_lvdata>=5.0.0.27,oglib_numeric>=4.1.0.8,oglib_string>=5.0.0.25,oglib_time>=4.0.1.3,levylab_lib_logger>=1.1.2.11"
Conflicts=""
...
File 5="user.lib/Levylab/Logger.PGSQL/Logger.PGSQL/Handle Error.vi"
...
File 16="user.lib/Levylab/Logger.PGSQL/Logger.PGSQL/Typedefs/PrivateEvents--Cluster.ctl"
File 17="user.lib/Levylab/Logger.PGSQL/Logger.PGSQL/Typedefs/PrivateEvents--Logger.PGSQL.Read Variable.ctl"
File 18="user.lib/Levylab/Logger.PGSQL/Logger.PGSQL/Typedefs/PrivateEvents--Logger.PGSQL.Set Address.ctl"
File 19="user.lib/Levylab/Logger.PGSQL/Logger.PGSQL/Typedefs/PrivateEvents--Logger.PGSQL.Write Variable Multiline.ctl"
...
File 23="user.lib/Levylab/Logger.PGSQL/Logger.PGSQL/private/Logger.GetPrivateEvents.vi"
File 24="user.lib/Levylab/Logger.PGSQL/Logger.PGSQL/private/Logger.PGSQL.Connect.vi"
File 25="user.lib/Levylab/Logger.PGSQL/Logger.PGSQL/private/Logger.PGSQL.Disconnect.vi"
File 26="user.lib/Levylab/Logger.PGSQL/Logger.PGSQL/private/Logger.PGSQL.Read.vi"
File 27="user.lib/Levylab/Logger.PGSQL/Logger.PGSQL/private/Logger.PGSQL.Write.vi"
File 28="user.lib/Levylab/Logger.PGSQL/Logger.PGSQL/private/Logger.PGSQL.WriteMultiline.vi"
File 29="user.lib/Levylab/Logger.PGSQL/Logger.PGSQL/private/Logger.ReadVariable.vi"
File 30="user.lib/Levylab/Logger.PGSQL/Logger.PGSQL/private/Write Or Not.vi"
