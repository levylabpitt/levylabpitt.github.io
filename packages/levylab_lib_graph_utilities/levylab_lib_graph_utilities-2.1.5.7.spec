...
Version="2.1.5.7"
Release=""
ID=6ab31fad1293ef605db457c5a6b0bffc
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[2.1.5]\0A- Add API method "Choose Color Table"\0A- Default Color Table is now Viridis\0A- Change Access scope and name of Create Custom Color Scale"
