...
Version="1.6.4.1"
Release=""
ID=74551695e1bfe18923ad286baca5c1e4
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="- Update to Instrument Framework v1.11.3.2 (fixes issues with PGSQL logging)\0A- Change Get Magnet.vi to directly ask SMO for value (backup to asking PGSQL)\0A- Add Get Magnet Vector Field API\0A- Change UI from 1.0 to 2.0 s getAll timout\0A- Minor changes to Handle Command variant to string"
...
[Dependencies]
AutoReqProv=FALSE
Requires="levylab_lib_levylab_instruments>=1.11.3.2"
Conflicts=""
...
File 74="user.lib/Levylab/Oxford-VRM/SMOs/Instrument.OxfordVRM/API/Close.vi"
File 75="user.lib/Levylab/Oxford-VRM/SMOs/Instrument.OxfordVRM/API/Get Magnet Vector Field.vi"
File 76="user.lib/Levylab/Oxford-VRM/SMOs/Instrument.OxfordVRM/API/Get Magnet.vi"
File 77="user.lib/Levylab/Oxford-VRM/SMOs/Instrument.OxfordVRM/API/Instrument.OxfordVRM.AbortSequence.vi"
File 78="user.lib/Levylab/Oxford-VRM/SMOs/Instrument.OxfordVRM/API/Instrument.OxfordVRM.GetPublicEvents.vi"
File 79="user.lib/Levylab/Oxford-VRM/SMOs/Instrument.OxfordVRM/API/Open.vi"
File 80="user.lib/Levylab/Oxford-VRM/SMOs/Instrument.OxfordVRM/API/Set Magnet Vector Field.vi"
File 81="user.lib/Levylab/Oxford-VRM/SMOs/Instrument.OxfordVRM/API/Set Magnet.vi"
