...
Version="1.0.1.2"
Release=""
ID=011f1c28d6bfaf140c5fc66cd9b1a432
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[1.0.1]\0A- change methods for creating request and response objects (use Make JSON Object instead of Set Item)\0A- change to response encoding: use same method as request object. Single elements (float, string, etc) will be converted to an array. This is done so that parsing of params and results can be done in the same way.\0A- updated palettes"
...
Replace Mode="Always"
Num Files=1
File 0="controls_Levylab_lib_json_rpc.mnu"
