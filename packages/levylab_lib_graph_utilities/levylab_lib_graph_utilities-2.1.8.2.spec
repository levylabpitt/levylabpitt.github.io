...
Version="2.1.8.2"
Release=""
ID=6554580f28d3c6ca4b57f7f57893454f
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[2.1.8]\0A- Update Horizontal and Vertical Linecuts to have step averaging option\0A- Updated to LV2019\0A- Update package dependencies"
...
[Dependencies]
AutoReqProv=FALSE
Requires="levylab_lib_xy_utilities>=1.4.0.17,mgi_lib_1d_array>=1.0.2.3,jki_lib_state_machine>=2018.0.7.45"
Conflicts=""
