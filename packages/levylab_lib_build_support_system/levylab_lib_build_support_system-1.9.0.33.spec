...
Version="1.9.0.33"
Release=""
ID=3a44d35c4dc4e80fe7f13a6f0a1050cf
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[1.9.0]\0A- fix bug in VIPM Increment Version Patch\0A- new methods to read and data from VIPB files\0A- add g-CLI tools for executing project builds without going through VIPM:\0A   - noVIPM_IncrementBuild\0A   - noVIPM_PostBuild\0A"
System Package="TRUE"
Sub Package="TRUE"
