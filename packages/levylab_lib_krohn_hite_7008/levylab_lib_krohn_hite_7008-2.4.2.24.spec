...
Version="2.4.2.24"
Release=""
ID=cf6dd2e34921c84bdd90dcad837a3cd7
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[2.4.2]\0Abuild with latest Instrument Framework stack (1.15.9)"
...
[Dependencies]
AutoReqProv=FALSE
Requires="levylab_lib_d2xx_lv>=1.3.0.8,levylab_lib_instrument_type>=1.1.4.11,levylab_lib_levylab_instruments>=1.15.9.45"
Conflicts=""
