...
Version="0.1.0.4"
Release=""
ID=be3ac5a69f185c8aedd3627f7af6db6b
File Format="vip"
Format Version="2017"
...
[Dependencies]
AutoReqProv=FALSE
Requires="jdp_science_jsontext>=1.9.0.124,jdp_science_lib_common_utilities>=1.4.1.18,jki_lib_state_machine>=2018.0.7.45,oglib_appcontrol>=4.1.0.7,ciozi137_lib_ciozi137_palette>=1.0.0.2"
Conflicts=""
