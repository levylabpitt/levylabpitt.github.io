...
Version="1.1.0.3"
Release=""
ID=21546e4d17c174dbe68930a2fd88e5d1
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[1.1.0]\0A- change API methods connectors to make method and params/response consistently on 2nd and 3rd rows, respectively\0A- update JSON-RPC encoding code\0A- add method for converting JSON to LVtype\0A- add methods for flattening/unflattening to string to JSON (faster than converting directly with JSONtext)"
