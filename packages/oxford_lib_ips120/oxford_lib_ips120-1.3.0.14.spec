...
Version="1.3.0.14"
Release=""
ID=c875b7298f2ab63deb81521b46f5f22a
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[1.3.0.14]\0A- update IPS120.lvclass to inherit from Instrument.Cryostat.lvclass\0A- override Get and Set Magnet Field methods defined by parent class\0A- automate exe and installer build"
