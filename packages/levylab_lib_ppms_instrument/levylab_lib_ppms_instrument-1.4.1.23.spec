...
Version="1.4.1.23"
Release=""
ID=b13e441ff67c58f8555d0c60428bf9a4
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[1.4.1.23]\0D\0AMany bug fixes to get PPMS/PPMS2 to work\0A- Fix show/hide PPMS Monitor and Control Launcher\0A- Fix configuration being passed to instrument class wire\0A- Fix self-terminate and stop instrument properly\0AMisc. UI improvements\0A\0Anote: Read Level? is not supported for the PPMS 1 in this release"
