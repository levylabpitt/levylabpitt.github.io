...
Version="1.2.2.12"
Release=""
ID=dfdcabc16a801dfb3c39f5d536614d9b
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[1.2.2]\0A#109 update calls to deprecated instruments\0A#110 fix waitForMagnet tolerance. default is now 1 mT (before was 0)"
...
[Dependencies]
AutoReqProv=FALSE
Requires="levylab_lib_control_experiment>=1.2.3.15,levylab_lib_transport>=1.9.3.15"
Conflicts=""
