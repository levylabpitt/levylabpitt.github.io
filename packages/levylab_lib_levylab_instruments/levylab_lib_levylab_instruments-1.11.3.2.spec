...
Version="1.11.3.2"
Release=""
ID=2f6d7affddfa9445057feac0a81d0347
File Format="vip"
Format Version="2017"
...
File 205="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Protected/Write Configuration Path.vi"
File 206="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Private/Get Dependencies.vi"
File 207="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Private/Instrument.GetPrivateEvents.vi"
File 208="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Private/Instrument.MessageFromProcess.vi"
File 209="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Overrides/CreatePrivateEvents.vi"
File 210="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Overrides/CreatePublicEvents.vi"
File 211="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Overrides/DestroyPrivateEvents.vi"
File 212="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Overrides/DestroyPublicEvents.vi"
File 213="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Overrides/enumerateStaticDependencies.vi"
File 214="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Close Hardware.vi"
File 215="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Close Instrument.vi"
File 216="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Close SMO.vi"
File 217="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Configuration Window.vi"
File 218="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Get SMO Address.vi"
File 219="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Get SMO Name.vi"
File 220="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Get SMO PGSQL Log Paths.vi"
File 221="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Get SMO Port.vi"
File 222="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Get SMO Public API.vi"
File 223="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Get SMO RC Type.vi"
File 224="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Handle Command.vi"
File 225="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Handle getAll.vi"
File 226="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Handle setConfiguration.vi"
File 227="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Open Hardware.vi"
File 228="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Open Instrument.vi"
File 229="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Open SMO.vi"
File 230="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Read Configuration File.vi"
File 231="user.lib/Levylab/Instrument Framework/SMOs/Instrument/Framework (for override)/Write Configuration File.vi"
File 232="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/ACK.vi"
File 233="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/Close.vi"
File 234="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/Create Instrument SMO.vi"
File 235="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/Enum to String.vi"
File 236="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/GET ALL.vim"
File 237="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/HELP.vi"
File 238="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/Instrument.GetPublicEvents.vi"
File 239="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/Instrument.LogPGSQL.vi"
File 240="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/Instrument.MessageToProcess.vi"
File 241="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/Open.vi"
File 242="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/Read Configuration Class.vi"
File 243="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/Read Debug Mode.vi"
File 244="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/Read Hardware Address.vi"
File 245="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/Remote Client.vim"
File 246="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/Send and Receive.vi"
File 247="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/SET CONFIG.vim"
File 248="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/State History.vi"
File 249="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/Variant to LV Data.vim"
File 250="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/Write Hardware Address.vi"
File 251="user.lib/Levylab/Instrument Framework/SMOs/Instrument/API/Write RC Type.vi"
File 252="user.lib/Levylab/Instrument Framework/SMOs/Configuration/Configuration.lvclass"
File 253="user.lib/Levylab/Instrument Framework/SMOs/Configuration/Default Path.vi"
File 254="user.lib/Levylab/Instrument Framework/SMOs/Configuration/Handle Missing Sections.vi"
File 255="user.lib/Levylab/Instrument Framework/SMOs/Configuration/Read Configuration (Template).vi"
File 256="user.lib/Levylab/Instrument Framework/SMOs/Configuration/Read Configuration.vi"
File 257="user.lib/Levylab/Instrument Framework/SMOs/Configuration/Read Path.vi"
File 258="user.lib/Levylab/Instrument Framework/SMOs/Configuration/Write Configuration.vi"
File 259="user.lib/Levylab/Instrument Framework/SMOs/Configuration/Write Path.vi"
File 260="user.lib/Levylab/Instrument Framework/Instrument Types/VSource/Get Bias Voltage.vi"
File 261="user.lib/Levylab/Instrument Framework/Instrument Types/VSource/Instrument.VSource.lvclass"
File 262="user.lib/Levylab/Instrument Framework/Instrument Types/VSource/Set Bias Voltage.vi"
File 263="user.lib/Levylab/Instrument Framework/Instrument Types/VNA/Get Data.vi"
File 264="user.lib/Levylab/Instrument Framework/Instrument Types/VNA/Instrument.VNA.lvclass"
File 265="user.lib/Levylab/Instrument Framework/Instrument Types/VNA/Set Average.vi"
File 266="user.lib/Levylab/Instrument Framework/Instrument Types/VNA/Set Format.vi"
File 267="user.lib/Levylab/Instrument Framework/Instrument Types/VNA/Set Measurement.vi"
File 268="user.lib/Levylab/Instrument Framework/Instrument Types/VNA/Set Power.vi"
File 269="user.lib/Levylab/Instrument Framework/Instrument Types/VNA/Set Sweep.vi"
File 270="user.lib/Levylab/Instrument Framework/Instrument Types/VNA/Typedefs/Conversion--enum.ctl"
File 271="user.lib/Levylab/Instrument Framework/Instrument Types/VNA/Typedefs/Format--enum.ctl"
File 272="user.lib/Levylab/Instrument Framework/Instrument Types/VNA/Typedefs/Measurement--enum.ctl"
File 273="user.lib/Levylab/Instrument Framework/Instrument Types/VNA/Typedefs/Sweep Type--enum.ctl"
File 274="user.lib/Levylab/Instrument Framework/Instrument Types/Strain/Get Strain.vi"
File 275="user.lib/Levylab/Instrument Framework/Instrument Types/Strain/Instrument.Strain.lvclass"
File 276="user.lib/Levylab/Instrument Framework/Instrument Types/Strain/Set Strain.vi"
File 277="user.lib/Levylab/Instrument Framework/Instrument Types/Lockin/Instrument.Lockin.lvclass"
File 278="user.lib/Levylab/Instrument Framework/Instrument Types/Lockin/Open.vi"
File 279="user.lib/Levylab/Instrument Framework/Instrument Types/Lockin/Placeholder.vi"
File 280="user.lib/Levylab/Instrument Framework/Instrument Types/Delay Line/Get Delay.vi"
File 281="user.lib/Levylab/Instrument Framework/Instrument Types/Delay Line/Instrument.DelayLine.lvclass"
File 282="user.lib/Levylab/Instrument Framework/Instrument Types/Delay Line/Set Delay.vi"
File 283="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Cryostat JSON.vi"
File 284="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Get Angle.vi"
File 285="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Get Chamber.vi"
File 286="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Get Helium Level.vi"
File 287="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Get Magnet.vi"
File 288="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Get Nitrogen Level.vi"
File 289="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Get Pressure.vi"
File 290="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Get Temperature.vi"
File 291="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Instrument.Cryostat.lvclass"
File 292="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Set Angle.vi"
File 293="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Set Chamber.vi"
File 294="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Set Magnet.vi"
File 295="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Set Temperature.vi"
File 296="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Wait for Magnet Setpoint.vi"
File 297="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Wait for Temperature Setpoint.vi"
File 298="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Typedefs/Magnet Axis--Enum.ctl"
File 299="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Typedefs/Magnet Mode--Enum.ctl"
File 300="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Typedefs/Rotator Axis--Enum.ctl"
File 301="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Typedefs/Set Angle--cluster.ctl"
File 302="user.lib/Levylab/Instrument Framework/Instrument Types/Cryostat/Typedefs/Set Chamber--cluster.ctl"
...
File 307="ProjectTemplates/Source/LevyLab/Instrument/Instrument-Template.lvproj"
File 308="ProjectTemplates/Source/LevyLab/Instrument/scripting/MetaDataObj.Instrument.lvclass"
File 309="ProjectTemplates/Source/LevyLab/Instrument/scripting/PostCopyScripting.vi"
File 310="ProjectTemplates/Source/LevyLab/Instrument/project files/.gitattributes"
File 311="ProjectTemplates/Source/LevyLab/Instrument/project files/.gitignore"
File 312="ProjectTemplates/Source/LevyLab/Instrument/project files/LICENSE"
File 313="ProjectTemplates/Source/LevyLab/Instrument/project files/README.md"
File 314="ProjectTemplates/Source/LevyLab/Instrument/project files/build support/buildspec-template.vipt.rename"
File 315="ProjectTemplates/Source/LevyLab/Instrument/project files/build support/icon.ico"
File 316="ProjectTemplates/Source/LevyLab/Instrument/project files/build support/Post-Build Custom Action.vi"
File 317="ProjectTemplates/Source/LevyLab/Instrument/images/instrument.png"
File 318="ProjectTemplates/MetaData/LevyLab_Instrument_MetaData.xml"
