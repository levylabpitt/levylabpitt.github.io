...
Version="2.5.0.27"
Release=""
ID=ab18e5fa85adb21c239ff5028e5cf199
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[2.5.0]\0A- build with pgsql/3.12.0.14 (improve database connection management)\0A- #34 fix reporting incorrect channel status"
...
[Dependencies]
AutoReqProv=FALSE
Requires="levylab_lib_d2xx_lv>=1.4.0.9,levylab_lib_instrument_type>=1.2.1.13,levylab_lib_levylab_instruments>=1.15.9.45"
Conflicts=""
