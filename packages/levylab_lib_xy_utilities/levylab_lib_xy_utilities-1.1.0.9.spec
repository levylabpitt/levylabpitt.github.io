...
Version="1.1.0.9"
Release=""
ID=504695afa105d7b80fa327cc07d930db
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="New methods:\0A- Decimate Array: decimates an array of XY-Data, leaving the X&Y arrays intact\0D\0A- Interpolate Parameter.vi: interpolate along "parameter" dimension\0A- Interpolate Y.vi: for a given x value interpolate and return a fractional Y value\0A- Shift Zero.vi: adjust zero value for a given fractional x index (useful for magnetic field sweeps)\0ABug Fixes:\0A- Interpolate.vi: now also interpolates the x array"
