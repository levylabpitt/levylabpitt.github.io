...
Version="0.3.3.19"
Release=""
ID=1cb89d9c6d03bc6d9f17916978d16f43
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="0.3.3:\0A- back save to LabVIEW 2016\0A- add support for pgpass credentials files (Issue #4)\0A- add support for COPY (issue #5)\0A\0AThanks to contributor Patrick Irvin (@ciozi137).\0A\0ANew in 0.2.2 :\0A- switch to LabVIEW 2017\0A- resolved issue #1 : add support for NI Linux RT Targets\0A- resolved issue #2 : add support for boolean parameter when executing single  command with parameters\0A- resolved issue #3 : improved parameter detection\0A\0AThanks to contributor Antoine Chalons (@antoinechalons) for their work on this release."
...
File 60="vi.lib/JDP Science/PostgreSQL Library/builds/jdp_science_postgresql-0.3.3.17.vip"
File 61="vi.lib/JDP Science/PostgreSQL Library/builds/jdp_science_postgresql-0.3.3.18.vip"
File 62="examples/JDP Science/PostgreSQL Library/PQ Example COPY file.vi"
File 63="examples/JDP Science/PostgreSQL Library/PQ Example COPY.vi"
File 64="examples/JDP Science/PostgreSQL Library/PQ Example Many INSERTs.vi"
File 65="examples/JDP Science/PostgreSQL Library/PQ Example SELECT Clusters.vi"
File 66="examples/JDP Science/PostgreSQL Library/PQ Example SELECT, Parameters.vi"
File 67="examples/JDP Science/PostgreSQL Library/Test MultiValue INSERT.vi"
