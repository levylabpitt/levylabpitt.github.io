...
Version="2.0.1.2"
Release=""
ID=30ed42f412bfc50cc30979c4fda256fa
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[2.0.1.2]\0ABug Fixes:\0A- Issue #1: Misc. bug fixes when converting an XY Graph to Intensity Graph\0A- Issue #3: Linecut width defaults to 1 pixel if user enters "0"\0A\0ANew Methods:\0A- Get/Set XY Graph X (Y) Mapping.vi (Get/Set Linear or Logarithmic XY Scales)\0A- Get/Set XY Graph Plot Names.vi\0A"
