...
Version="1.1.0.6"
Release=""
ID=a686105d35a7f2a1d4a808fb299f2df2
File Format="vip"
Format Version="2017"
...
[Description]
Description="Utilities for working with XY-data type (Cluster of 1D X and Y arrays).\0D\0A\0D\0ASupported methods:\0D\0A- Arithmetic: Add, Subtract, Multiply, Divide\0D\0A- Array: Sort, Reverse, Decimate, Subset, Sway X and Y, Get X and Y, Append, Waveform to XY\0D\0A- DSP: Derivative, Average, Interpolate, Resample, FFT Spectrum, FFT Power Spectrum"
Summary=""
License="BSD-3"
