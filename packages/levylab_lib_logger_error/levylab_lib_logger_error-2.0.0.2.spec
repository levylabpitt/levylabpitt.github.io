...
Version="2.0.0.2"
Release=""
ID=090df3f86ba75097572cc0c6ea65f8a6
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[2.0.0]\0A- #119 Debug Attribute\0A- #139 SMO 1.4 Error Handler\0A- #140 Macro: Exit\0A- #142 SMO v2.0 lvlib lvlibp"
...
[Dependencies]
AutoReqProv=FALSE
Requires="jki_lib_state_machine>=2018.0.7.45,jki_statemachineobjects>=2.0.0.73,oglib_appcontrol>=4.1.0.7,oglib_error>=4.2.0.23,oglib_lvdata>=5.0.0.27,oglib_string>=5.0.0.25,levylab_lib_build_support>=1.2.5.1"
Conflicts=""
