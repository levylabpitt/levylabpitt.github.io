...
Version="1.8.8.7"
Release=""
ID=54d0a4322b86c478ffc7b701af8368cf
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="- Update to Instrument Framework v1.12.4\0A- Give simulation mode its own port number\0A- UI keeps remote connection open\0A- Add error handling to UI to close and re-open bad ZMQ connection"
...
[Dependencies]
AutoReqProv=FALSE
Requires="levylab_lib_levylab_instruments>=1.12.4.1"
Conflicts=""
