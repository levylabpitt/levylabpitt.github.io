...
Version="1.7.0.28"
Release=""
ID=94c8a19ea10784bd77fd08601b74832f
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[1.7.0]\0A- Update to LV2019\0A- Instrument Framework v1.10\0A- Refactor KH7008 state machine and low-level drives\0A- "Get Parameters" is provided as low-level private method (will upgrade to API in future release)\0A- Updated package dependencies"
...
File 21="user.lib/LevyLab/Krohn Hite 7008/Private/KH7008 Get Channel.vi"
File 22="user.lib/LevyLab/Krohn Hite 7008/Private/KH7008 Parse Response String.vi"
File 23="user.lib/LevyLab/Krohn Hite 7008/Private/KH7008 Set All Channels.vi"
File 24="user.lib/LevyLab/Krohn Hite 7008/Private/KH7008 Set Channel.vi"
File 25="user.lib/LevyLab/Krohn Hite 7008/Overrides/Read Configuration File.vi"
File 26="user.lib/LevyLab/Krohn Hite 7008/Overrides/Write Configuration File.vi"
File 27="user.lib/LevyLab/Krohn Hite 7008/API/Read Channel Setting.vi"
File 28="user.lib/LevyLab/Krohn Hite 7008/API/Read Gain.vi"
File 29="user.lib/LevyLab/Krohn Hite 7008/API/Shunt - 500 or 10M Control Disable.vi"
File 30="user.lib/LevyLab/Krohn Hite 7008/API/Shunt - Check 500 or 10M.vi"
File 31="user.lib/LevyLab/Krohn Hite 7008/API/Write Channel Setting.vi"
