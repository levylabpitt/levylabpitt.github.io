...
Version="2.1.10.1"
Release=""
ID=1172c5e5b1dfc2471b997b4ffade6232
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[2.1.10]\0A- Updated palette and examples install location\0A- Updated package dependencies"
...
File 62="user.lib/LevyLab/Graph Utilities/API/Intensity Graph Linecut (Horizontal) (by ref).vi"
File 63="user.lib/LevyLab/Graph Utilities/API/Intensity Graph Linecut (Horizontal) (by val).vi"
File 64="user.lib/LevyLab/Graph Utilities/API/Intensity Graph Linecut (Vertical) (by ref).vi"
File 65="user.lib/LevyLab/Graph Utilities/API/Intensity Graph Linecut (Vertical) (by val).vi"
File 66="user.lib/LevyLab/Graph Utilities/API/Intensity Graph to XY Graph (Horizontal) (by ref).vi"
File 67="user.lib/LevyLab/Graph Utilities/API/Intensity Graph to XY Graph (Horizontal) (by val).vi"
File 68="user.lib/LevyLab/Graph Utilities/API/Intensity Graph to XY Graph (Vertical) (by ref).vi"
File 69="user.lib/LevyLab/Graph Utilities/API/Intensity Graph to XY Graph (Vertical) (by val).vi"
File 70="user.lib/LevyLab/Graph Utilities/API/XY Graph to Intensity Graph (by ref).vi"
File 71="user.lib/LevyLab/Graph Utilities/API/XY Graph to Intensity Graph (by val).vi"
