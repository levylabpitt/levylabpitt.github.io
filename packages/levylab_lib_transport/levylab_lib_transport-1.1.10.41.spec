...
Version="1.1.10.41"
Release=""
ID=f26ff6a9dac3c142b12870f09dd59f76
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[1.1.10.41]\0A- add APIs to read *experiment*.json descriptor files\0A\0ALockin_Vsg\0A- Fix issue where initial wait time would not be set properly\0A- Update front panel controls for Experiment Folder and Experiment when called as subVI of Sweep Control\0A\0ALockin_Sweep\0A- Modify to support newest Lockin sweep mode (sweeps multiple channels)\0A\0AContinuous B Sweep.vi\0A- Fix issue where notifier was not added to data cluster\0A\0AControl Experiment.lvclass\0A- Add accessor Read Experiment Description.vi"
