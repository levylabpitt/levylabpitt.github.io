...
Version="1.1.11.42"
Release=""
ID=b69c532f7622fcc6656d1eb183586bfd
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[1.1.11.42]\0AContinuous B Sweep.vi and Sweep Control.vi\0A- Add calls to Lockin_Sweep\0A\0ALockin_Sweep\0A- Fix issue that would not properly reset graphs\0A- Update the way final sweep results are calculated and displayed\0A\0AControl Experiment.vi\0A- Change fonts to (hopefully) be more uniform across operating systems"
