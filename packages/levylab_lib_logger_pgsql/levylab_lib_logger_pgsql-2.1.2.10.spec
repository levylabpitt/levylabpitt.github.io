...
Version="2.1.2.10"
Release=""
ID=6cbb03b118a0e7bf2b1c942cadfdfe31
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[2.1.1]\0A- Remove call to 'shorten cluter' in process.vi: client application should ensure that the cluster size and number of addresses are equal"
