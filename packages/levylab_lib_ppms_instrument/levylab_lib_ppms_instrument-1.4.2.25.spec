...
Version="1.4.2.25"
Release=""
ID=41786d2fe7dacc734ac35fe455b95af5
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[1.4.2.25]\0D\0A- Change UI window appearance settings\0A- Fully automated build (from *.vip to Self-Extracting installer *.exe)\0A\0Anote: Read Level? is not supported for the PPMS 1 in this release"
