...
Version="2.0.0.7"
Release=""
ID=f5e59764deb4aaff2015cf88db66ea71
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[2.0.0]\0A- #119 Debug Attribute\0A- #139 SMO 1.4 Error Handler\0A- #140 Macro: Exit\0A- #142 SMO v2.0 lvlib (not lvlibp)\0A- remove unused methods (Write to PGSQL)"
