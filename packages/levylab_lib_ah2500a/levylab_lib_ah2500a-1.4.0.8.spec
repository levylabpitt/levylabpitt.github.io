...
Version="1.4.0.8"
Release=""
ID=79a85e998896910a90bbc330639d0ee2
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[1.4.0]\0A- Add SHOW SPECIAL hardware driver\0A- Add Open/Close hardware drivers\0A- Add Get SMO Serial Number and Get SMO Vendor overrides\0A- Ensure UI uses only "local" communication\0A- Updated ZMQ backend"
