...
Version="2.8.2.13"
Release=""
ID=242c27118d91dee7a6ffaada983e4910
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[2.8.2.13]\0A- Variant to Array will now return an error if the data type is unsupported\0A- Rename files in /util\0A- Remove unused or redundant methods\0A- Format Path and Filename should now support different filenames in the same directory"
