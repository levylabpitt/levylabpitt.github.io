...
Version="2.8.6.15"
Release=""
ID=a5079a8c1b100213ec16f275ebf45a2d
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[2.8.6.15]\0A- Change default max/min for aux out to be +/- 10 V\0A- Fix error that would not write DC values to AO waveform when task is created"
