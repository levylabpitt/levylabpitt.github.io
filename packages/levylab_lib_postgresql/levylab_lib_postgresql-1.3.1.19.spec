...
Version="1.3.1.19"
Release=""
ID=6d7ad647d60e5ced22095108595e16a5
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="- Fix issues with number formatting:\0A  - Issue #65: Coerce infinite. Numbers larger than +/-1E22 are represented as '+/- Infinity'\0A  - Issue #68: double format. Numbers are now converted with 15 digits of precision (smallest possible number is 1E-15; previously smallest number was 1E-6)\0A  - Issue #69: integer format. All supported integers were converted to 'NaN'"
