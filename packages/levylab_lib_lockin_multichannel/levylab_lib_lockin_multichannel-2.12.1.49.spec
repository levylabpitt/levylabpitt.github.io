...
Version="2.12.1.49"
Release=""
ID=5c7ea2cc49423c18b63148c875368ff1
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="[2.12.1]\0A\0D- Update to Instrument Framework v1.7 (fixes missing LevyLab.lvclass issue)\0A- Change the way Lockin Engine handles waveform arrays (applies low pass filter to interleved X and Y channels rather than parallel low pass filters)\0A- Lockin Engine organized into subVIs\0A- fix Sweep issue"
