...
Version="1.1.1.30"
Release=""
ID=56087420bc809f6e06b87c1e621dd956
File Format="vip"
Format Version="2017"
...
Packager="Joe Albro"
Demo="FALSE"
Release Notes="- Backsave to LV2019\0A- Reorganize files on disk\0A- Include MAUI Template"
...
[Dependencies]
AutoReqProv=FALSE
Requires="jki_lib_state_machine>=2018.0.7.45,jki_statemachineobjects>=1.4.0.63,oglib_error>=4.2.0.23,oglib_lvdata>=5.0.0.27,oglib_variantconfig>=4.0.0.5,levylab_lib_embedded_smo_ui>=1.0.2.15"
Conflicts=""
