...
Version="2.6.9.26"
Release=""
ID=d587d89a0a9a78d7191b16369d99baeb
File Format="vip"
Format Version="2017"
...
Demo="FALSE"
Release Notes="- remove calls to color utilities package\0A- remove color utilities and control experiment dependencies\0A- update Help icons"
...
[Dependencies]
AutoReqProv=FALSE
Requires="levylab_lib_fileutilities>=1.2.2.8,levylab_lib_graph_utilities>=1.1.0.7,levylab_lib_ibwtolv>=1.0.0.2,oglib_string>=4.1.0.12"
Conflicts=""
